...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("https://api-us-west-2.graphcms.com/v2/ck2u0yms81him01c95r6i6noi/master", {
    method: "POST",
    ...({"headers":{"Authorization":"Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6ImdjbXMtbWFpbi1wcm9kdWN0aW9uIn0..ep9oaGyVPof-LKDNSM7NoNyXCqeiKxw7Si9w0k_xXVBtYL_vzykpMPEB1DPk_BReUxZrQz_cZSGyhDKvtfETtgs68Ws4oBv699ZJIcYZKkwyzIigJG9Im0JEuYEWZfzMK2ecc8tHIJczZZSOTDP4-ohdgbnDi22tJNwa59J1Qrk1hK5ejxTgzzduxD7fCBTYnI2yGqbjpa4MmFCgTXoEJyZdgbJALbiiiVcBJvyv52IADIyZqmrwBT9aL2BtIBEEFFL1tqZ2a2MT8tNkm8YOFZvYDkdmWwPJYYFY29FGHyzJns7X-W9YHOivE0bMOEdinv9BMYGo9tQ4vp5VuONm0UVyB7hXUXbAQ5fW7eCFO6Ly7GPDMGQ8YUVuuGgJrZB3_A3rSOS3I6dMAMqjGIj3oXAFozu8WlEC4DMZrSQBbPlHXsEBKd4T_QF2k0j6Zm98AlLFWTbx8m9SA9pmAd6o2ie9y26avlw2UdsOXNlO6NMCisuOq0DGJBR83aBb4o3d62pRHnfqKdJ8v1OZtP6Fg0vSWruh_fwKX9QWIhyoPioqvWOllYfqJbNRWUpmwyzqdlEc1XTD9Y4idcQdLTHDPjEcY9QBxlrutxGpwZya_jUgEsMJlsvzDBkuJuYDm3S2QL8PuSE7oErN7g-ixeEh3_uAaXl0ZDGSmCmK28Onq1E"}}),
...
export type AssetCreateInput = {
  ...
  imageDesktopProject?: InputMaybe<ProjectCreateManyInlineInput>;
...
export type AssetManyWhereInput = {
  ...
  imageDesktopProject_every?: InputMaybe<ProjectWhereInput>;
  imageDesktopProject_none?: InputMaybe<ProjectWhereInput>;
  imageDesktopProject_some?: InputMaybe<ProjectWhereInput>;
...
export type AssetUpdateInput = {
  ...
  height?: InputMaybe<Scalars['Float']['input']>;
  imageDesktopProject?: InputMaybe<ProjectUpdateManyInlineInput>;
...
export type MutationDeleteManySocialLinksArgs = {
  where?: InputMaybe<SocialLinkManyWhereInput>;
};
...
export type Project = Entity & Node & {
  ...
  lastDeployedOn?: Maybe<Scalars['DateTime']['output']>;
  linkType?: Maybe<ProjectLinkType>;
  /** Order the project is displayed */
  order?: Maybe<Scalars['Int']['output']>;
  overview?: Maybe<Scalars['String']['output']>;
  projectId: Scalars['String']['output'];
  projectPublishDate?: Maybe<Scalars['Date']['output']>;
  ...
  techList: Array<Scalars['String']['output']>;
...
export type ProjectCreateInput = {
  ...
  imageDesktop?: InputMaybe<AssetCreateOneInlineInput>;
  lastDeployedOn?: InputMaybe<Scalars['DateTime']['input']>;
  linkType?: InputMaybe<ProjectLinkType>;
  order?: InputMaybe<Scalars['Int']['input']>;
  overview?: InputMaybe<Scalars['String']['input']>;
  projectId: Scalars['String']['input'];
  projectPublishDate?: InputMaybe<Scalars['Date']['input']>;
  projectType: ProjectType;
  storybookUrl?: InputMaybe<Scalars['String']['input']>;
  team?: InputMaybe<Array<Scalars['String']['input']>>;
  techList?: InputMaybe<Array<Scalars['String']['input']>>;
...
export type ProjectManyWhereInput = {
  ...
  githubRepoUrl?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  githubRepoUrl_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  githubRepoUrl_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  githubRepoUrl_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  githubRepoUrl_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  githubRepoUrl_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  githubRepoUrl_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  githubRepoUrl_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  githubRepoUrl_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  githubRepoUrl_starts_with?: InputMaybe<Scalars['String']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
  ...
  /** All values starting with the given string. */
  id_starts_with?: InputMaybe<Scalars['ID']['input']>;
  imageDesktop?: InputMaybe<AssetWhereInput>;
  lastDeployedOn?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than the given value. */
  lastDeployedOn_gt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values greater than or equal the given value. */
  lastDeployedOn_gte?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values that are contained in given list. */
  lastDeployedOn_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  /** All values less than the given value. */
  lastDeployedOn_lt?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values less than or equal the given value. */
  lastDeployedOn_lte?: InputMaybe<Scalars['DateTime']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  lastDeployedOn_not?: InputMaybe<Scalars['DateTime']['input']>;
  /** All values that are not contained in given list. */
  lastDeployedOn_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  linkType?: InputMaybe<ProjectLinkType>;
  /** All values that are contained in given list. */
  linkType_in?: InputMaybe<Array<InputMaybe<ProjectLinkType>>>;
  /** Any other value that exists and is not equal to the given value. */
  linkType_not?: InputMaybe<ProjectLinkType>;
  /** All values that are not contained in given list. */
  linkType_not_in?: InputMaybe<Array<InputMaybe<ProjectLinkType>>>;
  order?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than the given value. */
  ...
  /** All values containing the given string. */
  projectId_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  projectId_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  projectId_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  projectId_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  projectId_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  projectId_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  projectId_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  projectId_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  projectId_starts_with?: InputMaybe<Scalars['String']['input']>;
  projectPublishDate?: InputMaybe<Scalars['Date']['input']>;
  /** All values greater than the given value. */
  projectPublishDate_gt?: InputMaybe<Scalars['Date']['input']>;
  /** All values greater than or equal the given value. */
  projectPublishDate_gte?: InputMaybe<Scalars['Date']['input']>;
  /** All values that are contained in given list. */
  projectPublishDate_in?: InputMaybe<Array<InputMaybe<Scalars['Date']['input']>>>;
  /** All values less than the given value. */
  projectPublishDate_lt?: InputMaybe<Scalars['Date']['input']>;
  /** All values less than or equal the given value. */
  projectPublishDate_lte?: InputMaybe<Scalars['Date']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  projectPublishDate_not?: InputMaybe<Scalars['Date']['input']>;
  /** All values that are not contained in given list. */
  projectPublishDate_not_in?: InputMaybe<Array<InputMaybe<Scalars['Date']['input']>>>;
  ...
  storybookUrl?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  storybookUrl_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  storybookUrl_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  storybookUrl_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  storybookUrl_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  storybookUrl_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  storybookUrl_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  storybookUrl_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  storybookUrl_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  storybookUrl_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** Matches if the field array contains *all* items provided to the filter and order does match */
  team?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  team_contains_all?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  team_contains_none?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  team_contains_some?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  team_not?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains *all* items provided to the filter and order does match */
  techList?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains *all* items provided to the filter */
  techList_contains_all?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contain any of the items provided to the filter */
  techList_contains_none?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array contains at least one item provided to the filter */
  techList_contains_some?: InputMaybe<Array<Scalars['String']['input']>>;
  /** Matches if the field array does not contains *all* items provided to the filter or order does not match */
  techList_not?: InputMaybe<Array<Scalars['String']['input']>>;
...
export type ProjectUpdateInput = {
  ...
  externalUrl?: InputMaybe<Scalars['String']['input']>;
  githubRepoUrl?: InputMaybe<Scalars['String']['input']>;
  imageDesktop?: InputMaybe<AssetUpdateOneInlineInput>;
  lastDeployedOn?: InputMaybe<Scalars['DateTime']['input']>;
  linkType?: InputMaybe<ProjectLinkType>;
  order?: InputMaybe<Scalars['Int']['input']>;
  overview?: InputMaybe<Scalars['String']['input']>;
...
export type Skill = Entity & Node & {
  ...
  /** User that last updated this document */
  updatedBy?: Maybe<User>;
  xAxisDesktop?: Maybe<Scalars['Int']['output']>;
  xAxisMobile?: Maybe<Scalars['Int']['output']>;
  yAxisDesktop?: Maybe<Scalars['Int']['output']>;
  yAxisMobile?: Maybe<Scalars['Int']['output']>;
};
...
export type SkillCreateInput = {
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  directionDesktop?: InputMaybe<SkillsDirection>;
  directionMobile?: InputMaybe<SkillsDirection>;
  label: Scalars['String']['input'];
  updatedAt?: InputMaybe<Scalars['DateTime']['input']>;
  xAxisDesktop?: InputMaybe<Scalars['Int']['input']>;
  xAxisMobile?: InputMaybe<Scalars['Int']['input']>;
  yAxisDesktop?: InputMaybe<Scalars['Int']['input']>;
  yAxisMobile?: InputMaybe<Scalars['Int']['input']>;
};
...
export type SkillManyWhereInput = {
  ...
  directionDesktop?: InputMaybe<SkillsDirection>;
  /** All values that are contained in given list. */
  directionDesktop_in?: InputMaybe<Array<InputMaybe<SkillsDirection>>>;
  /** Any other value that exists and is not equal to the given value. */
  directionDesktop_not?: InputMaybe<SkillsDirection>;
  /** All values that are not contained in given list. */
  directionDesktop_not_in?: InputMaybe<Array<InputMaybe<SkillsDirection>>>;
  directionMobile?: InputMaybe<SkillsDirection>;
  /** All values that are contained in given list. */
  directionMobile_in?: InputMaybe<Array<InputMaybe<SkillsDirection>>>;
  /** Any other value that exists and is not equal to the given value. */
  directionMobile_not?: InputMaybe<SkillsDirection>;
  /** All values that are not contained in given list. */
  directionMobile_not_in?: InputMaybe<Array<InputMaybe<SkillsDirection>>>;
  ...
  xAxisDesktop?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than the given value. */
  xAxisDesktop_gt?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than or equal the given value. */
  xAxisDesktop_gte?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are contained in given list. */
  xAxisDesktop_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  /** All values less than the given value. */
  xAxisDesktop_lt?: InputMaybe<Scalars['Int']['input']>;
  /** All values less than or equal the given value. */
  xAxisDesktop_lte?: InputMaybe<Scalars['Int']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  xAxisDesktop_not?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are not contained in given list. */
  xAxisDesktop_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  xAxisMobile?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than the given value. */
  xAxisMobile_gt?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than or equal the given value. */
  xAxisMobile_gte?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are contained in given list. */
  xAxisMobile_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  /** All values less than the given value. */
  xAxisMobile_lt?: InputMaybe<Scalars['Int']['input']>;
  /** All values less than or equal the given value. */
  xAxisMobile_lte?: InputMaybe<Scalars['Int']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  xAxisMobile_not?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are not contained in given list. */
  xAxisMobile_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  yAxisDesktop?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than the given value. */
  yAxisDesktop_gt?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than or equal the given value. */
  yAxisDesktop_gte?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are contained in given list. */
  yAxisDesktop_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  /** All values less than the given value. */
  yAxisDesktop_lt?: InputMaybe<Scalars['Int']['input']>;
  /** All values less than or equal the given value. */
  yAxisDesktop_lte?: InputMaybe<Scalars['Int']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  yAxisDesktop_not?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are not contained in given list. */
  yAxisDesktop_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  yAxisMobile?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than the given value. */
  yAxisMobile_gt?: InputMaybe<Scalars['Int']['input']>;
  /** All values greater than or equal the given value. */
  yAxisMobile_gte?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are contained in given list. */
  yAxisMobile_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
  /** All values less than the given value. */
  yAxisMobile_lt?: InputMaybe<Scalars['Int']['input']>;
  /** All values less than or equal the given value. */
  yAxisMobile_lte?: InputMaybe<Scalars['Int']['input']>;
  /** Any other value that exists and is not equal to the given value. */
  yAxisMobile_not?: InputMaybe<Scalars['Int']['input']>;
  /** All values that are not contained in given list. */
  yAxisMobile_not_in?: InputMaybe<Array<InputMaybe<Scalars['Int']['input']>>>;
};
...
/** Social media links */
export type SocialLink = Entity & Node & {
...
export type SocialLinkCreateManyInlineInput = {
  ...
  connect?: InputMaybe<Array<SocialLinkWhereUniqueInput>>;
...
export type SocialLinkCreateOneInlineInput = {
  ...
  connect?: InputMaybe<SocialLinkWhereUniqueInput>;
...
export type SocialLinkManyWhereInput = {
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  documentInStages_every?: InputMaybe<SocialLinkWhereStageInput>;
  documentInStages_none?: InputMaybe<SocialLinkWhereStageInput>;
  documentInStages_some?: InputMaybe<SocialLinkWhereStageInput>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
  id_contains?: InputMaybe<Scalars['ID']['input']>;
  /** All values ending with the given string. */
...
export type SocialLinkUpdateManyInlineInput = {
  /** Connect multiple existing SocialLink documents */
  connect?: InputMaybe<Array<SocialLinkConnectInput>>;
  ...
  disconnect?: InputMaybe<Array<SocialLinkWhereUniqueInput>>;
  /** Override currently-connected documents with multiple existing SocialLink documents */
  set?: InputMaybe<Array<SocialLinkWhereUniqueInput>>;
  /** Update multiple SocialLink documents */
  update?: InputMaybe<Array<SocialLinkUpdateWithNestedWhereUniqueInput>>;
  /** Upsert multiple SocialLink documents */
  upsert?: InputMaybe<Array<SocialLinkUpsertWithNestedWhereUniqueInput>>;
};
...
/** This contains a set of filters that can be used to compare values internally */
export type SocialLinkWhereComparatorInput = {
  /** This field can be used to request to check if the entry is outdated by internal comparison */
  outdated_to?: InputMaybe<Scalars['Boolean']['input']>;
};
...
/** The document in stages filter allows specifying a stage entry to cross compare the same document between different stages */
export type SocialLinkWhereStageInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<SocialLinkWhereStageInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<SocialLinkWhereStageInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<SocialLinkWhereStageInput>>;
  /** This field contains fields which can be set as true or false to specify an internal comparison */
  compareWithParent?: InputMaybe<SocialLinkWhereComparatorInput>;
  /** Specify the stage to compare with */
  stage?: InputMaybe<Stage>;
};
...
export type GetAboutMeSectionQuery = { __typename?: 'Query', aboutMeSection?: { __typename?: 'Section', heading?: string | null, body?: { __typename?: 'RichText', html: string } | null } | null };

export type GetAllProjectIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllProjectIdsQuery = { __typename?: 'Query', projects: Array<{ __typename?: 'Project', projectId: string }> };
...
export type GetCaseStudyQuery = { __typename?: 'Query', sections: Array<{ __typename?: 'Section', sectionId?: string | null, heading?: string | null }>, projects: Array<{ __typename?: 'Project', id: string, projectId: string, projectType: ProjectType, title: string, order?: number | null }>, project?: { __typename?: 'Project', updatedAt: any, createdAt: any, id: string, projectId: string, title: string, projectType: ProjectType, description?: string | null, techList: Array<string>, externalUrl?: string | null, overview?: string | null, lastDeployedOn?: any | null, projectPublishDate?: any | null, storybookUrl?: string | null, order?: number | null, githubRepoUrl?: string | null, team: Array<string>, imageDesktop?: { __typename?: 'Asset', fileName: string, height?: number | null, width?: number | null } | null, body?: { __typename?: 'RichText', raw: any } | null } | null };

export type GetRecentWorkQueryVariables = Exact<{ [key: string]: never; }>;


export type GetRecentWorkQuery = { __typename?: 'Query', recentWorkSection?: { __typename?: 'Section', heading?: string | null } | null, projects: Array<{ __typename?: 'Project', id: string, projectType: ProjectType, title: string, description?: string | null, projectId: string, externalUrl?: string | null, linkType?: ProjectLinkType | null, order?: number | null, imageDesktop?: { __typename?: 'Asset', url: string } | null }> };

export type GetSkillsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSkillsQuery = { __typename?: 'Query', skills: Array<{ __typename?: 'Skill', xAxisDesktop?: number | null, xAxisMobile?: number | null, yAxisDesktop?: number | null, yAxisMobile?: number | null, directionDesktop?: SkillsDirection | null, directionMobile?: SkillsDirection | null, id: string, label: string }> };

export type GetSocialLinksQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSocialLinksQuery = { __typename?: 'Query', socialLinks: Array<{ __typename?: 'SocialLink', id: string, label: string, url?: string | null }> };



export const GetAboutMeSectionDocument = `
    query getAboutMeSection {
  aboutMeSection: section(where: {sectionId: "about-me"}) {
    heading
    body {
      html
    }
...
export const useGetAboutMeSectionQuery = <
      TData = GetAboutMeSectionQuery,
      TError = unknown
    >(
      variables?: GetAboutMeSectionQueryVariables,
      options?: UseQueryOptions<GetAboutMeSectionQuery, TError, TData>
    ) => {
    
    return useQuery<GetAboutMeSectionQuery, TError, TData>(
      variables === undefined ? ['getAboutMeSection'] : ['getAboutMeSection', variables],
      fetcher<GetAboutMeSectionQuery, GetAboutMeSectionQueryVariables>(GetAboutMeSectionDocument, variables),
      options
    )};

useGetAboutMeSectionQuery.getKey = (variables?: GetAboutMeSectionQueryVariables) => variables === undefined ? ['getAboutMeSection'] : ['getAboutMeSection', variables];


useGetAboutMeSectionQuery.fetcher = (variables?: GetAboutMeSectionQueryVariables) => fetcher<GetAboutMeSectionQuery, GetAboutMeSectionQueryVariables>(GetAboutMeSectionDocument, variables);

export const GetAllProjectIdsDocument = `
...
export const useGetAllProjectIdsQuery = <
      TData = GetAllProjectIdsQuery,
      TError = unknown
    >(
      variables?: GetAllProjectIdsQueryVariables,
      options?: UseQueryOptions<GetAllProjectIdsQuery, TError, TData>
    ) => {
    
    return useQuery<GetAllProjectIdsQuery, TError, TData>(
      variables === undefined ? ['getAllProjectIds'] : ['getAllProjectIds', variables],
      fetcher<GetAllProjectIdsQuery, GetAllProjectIdsQueryVariables>(GetAllProjectIdsDocument, variables),
      options
    )};

useGetAllProjectIdsQuery.getKey = (variables?: GetAllProjectIdsQueryVariables) => variables === undefined ? ['getAllProjectIds'] : ['getAllProjectIds', variables];


useGetAllProjectIdsQuery.fetcher = (variables?: GetAllProjectIdsQueryVariables) => fetcher<GetAllProjectIdsQuery, GetAllProjectIdsQueryVariables>(GetAllProjectIdsDocument, variables);

export const GetCaseStudyDocument = `
...
export const useGetCaseStudyQuery = <
      TData = GetCaseStudyQuery,
      TError = unknown
    >(
      variables: GetCaseStudyQueryVariables,
      options?: UseQueryOptions<GetCaseStudyQuery, TError, TData>
    ) => {
    
    return useQuery<GetCaseStudyQuery, TError, TData>(
      ['getCaseStudy', variables],
      fetcher<GetCaseStudyQuery, GetCaseStudyQueryVariables>(GetCaseStudyDocument, variables),
      options
    )};

useGetCaseStudyQuery.getKey = (variables: GetCaseStudyQueryVariables) => ['getCaseStudy', variables];


useGetCaseStudyQuery.fetcher = (variables: GetCaseStudyQueryVariables) => fetcher<GetCaseStudyQuery, GetCaseStudyQueryVariables>(GetCaseStudyDocument, variables);

export const GetRecentWorkDocument = `
    query getRecentWork {
...
export const useGetRecentWorkQuery = <
      TData = GetRecentWorkQuery,
      TError = unknown
    >(
      variables?: GetRecentWorkQueryVariables,
      options?: UseQueryOptions<GetRecentWorkQuery, TError, TData>
    ) => {
    
    return useQuery<GetRecentWorkQuery, TError, TData>(
      variables === undefined ? ['getRecentWork'] : ['getRecentWork', variables],
      fetcher<GetRecentWorkQuery, GetRecentWorkQueryVariables>(GetRecentWorkDocument, variables),
      options
    )};

useGetRecentWorkQuery.getKey = (variables?: GetRecentWorkQueryVariables) => variables === undefined ? ['getRecentWork'] : ['getRecentWork', variables];


useGetRecentWorkQuery.fetcher = (variables?: GetRecentWorkQueryVariables) => fetcher<GetRecentWorkQuery, GetRecentWorkQueryVariables>(GetRecentWorkDocument, variables);
...
export const useGetSkillsQuery = <
      TData = GetSkillsQuery,
      TError = unknown
    >(
      variables?: GetSkillsQueryVariables,
      options?: UseQueryOptions<GetSkillsQuery, TError, TData>
    ) => {
    
    return useQuery<GetSkillsQuery, TError, TData>(
      variables === undefined ? ['getSkills'] : ['getSkills', variables],
      fetcher<GetSkillsQuery, GetSkillsQueryVariables>(GetSkillsDocument, variables),
      options
    )};

useGetSkillsQuery.getKey = (variables?: GetSkillsQueryVariables) => variables === undefined ? ['getSkills'] : ['getSkills', variables];


useGetSkillsQuery.fetcher = (variables?: GetSkillsQueryVariables) => fetcher<GetSkillsQuery, GetSkillsQueryVariables>(GetSkillsDocument, variables);
...
export const useGetSocialLinksQuery = <
      TData = GetSocialLinksQuery,
      TError = unknown
    >(
      variables?: GetSocialLinksQueryVariables,
      options?: UseQueryOptions<GetSocialLinksQuery, TError, TData>
    ) => {
    
    return useQuery<GetSocialLinksQuery, TError, TData>(
      variables === undefined ? ['getSocialLinks'] : ['getSocialLinks', variables],
      fetcher<GetSocialLinksQuery, GetSocialLinksQueryVariables>(GetSocialLinksDocument, variables),
      options
    )};

useGetSocialLinksQuery.getKey = (variables?: GetSocialLinksQueryVariables) => variables === undefined ? ['getSocialLinks'] : ['getSocialLinks', variables];


useGetSocialLinksQuery.fetcher = (variables?: GetSocialLinksQueryVariables) => fetcher<GetSocialLinksQuery, GetSocialLinksQueryVariables>(GetSocialLinksDocument, variables);
