...
export const getBlockAnimation = (config: GetBlockAnimation): FlattenSimpleInterpolation => {
    ...
    switch (`${transition}-${type}`) {
        case 'enter-blocks':
            return css`
                animation: ${enterFrames} ${slow} ease-in forwards;
            `;
        ...
        case 'enter-full':
            return css`
                animation: ${enterFrames} 1000ms ease-in-out forwards;
            `;
        case 'exit-blocks':
            return css`
                animation: ${exitFrames} ${slow} ease-in forwards;
            `;
        ...
        case 'exit-full':
            return css`
                animation: ${exitFrames} 1000ms ease-in-out forwards;
            `;
        default:
            return css`
                animation: none;
