...
export const RecentWorkParticle = styled('div')<RecentWorkParticleProps>`
  ...
  ${({ particleID }) => particleID.includes('dot-grid-') && css`
    ...
    `}
  `}
  ${({ particleID }) => particleID === 'dot-grid-a' && css`
    top: -1%;
    left: 71%;
  `}
  ${({ particleID }) => particleID === 'dot-grid-b' && css`
    top: 78%;
    left: 75.3%;
  `}
  ${({ particleID }) => particleID === 'dot-grid-c' && css`
    top: 50%;
    left: 4%;
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-a' && css`
    ${gridPosition({ gridLines, attach: 'right' })}
    top: 6%;
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-b' && css`
   ${gridPosition({ gridLines, index: 4, attach: 'right' })}
    ...
    `}
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-c' && css`
    ...
    `}
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-d' && css`
    ...
    `}
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-e' && css`
    ...
    `}
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-f' && css`
    ${gridPosition({ gridLines, index: 6, attach: 'right' })}
    top: -12%;
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-g' && css`
    ${gridPosition({ gridLines, index: 1, attach: 'right' })}
    display: none;
    top: 92%;
    ${media.tablet`
    ...
    `}
  `}
  ${({ particleID, gridLines }) => particleID === 'triangle-h' && css`
    ${gridPosition({ gridLines, index: 3, attach: 'right' })}
    display: none;
    top: 99%;
    ${media.tablet`
